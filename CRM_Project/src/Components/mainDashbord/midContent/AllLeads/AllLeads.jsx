...
// import { useOutletContext, useNavigate, Outlet, useLocation } from 'react-router-dom'; // ❌ No longer needed
import { useNavigate, Outlet, useLocation } from 'react-router-dom'; // ✅ Simplified imports
import { useDarkMode } from '../../../../context/DarkModeContext'; // ✅ Import the custom hook

const AllLeads = () => {
  // const { darkMode } = useOutletContext(); // ❌ Changed this
            ...
            >
              ...
              >
                <button
                  ...
                  onClick={() => navigate(`/mainDashboard/lead-details/${lead._id}`)}
                >
                  view
                </button>
              </div>
